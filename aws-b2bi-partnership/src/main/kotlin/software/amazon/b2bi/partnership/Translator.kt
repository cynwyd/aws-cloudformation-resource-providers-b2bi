                    ...
                    SdkX12OutboundEdiHeaders.builder()
                        .interchangeControlHeaders(
                            SdkX12InterchangeControlHeaders.builder()
                                ...
                                .controlVersionNumberCode(resourceInterchangeControlHeaders?.controlVersionNumberCode)
                    ...
                    ResourceX12OutboundEdiHeaders.builder()
                        .interchangeControlHeaders(
                            ResourceX12InterchangeControlHeaders.builder()
                                ...
                                .controlVersionNumberCode(sdkInterchangeControlHeaders?.controlVersionNumberCode())
